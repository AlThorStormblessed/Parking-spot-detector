...
##parking_crop
# parking_slots = [(64, 7), (62, 63), (64, 126), (68, 183), (67, 243), (66, 307), (69, 365), (229, 10), (232, 64), (236, 124), (233, 182), (235, 243), (236, 303), (238, 361)]
# rect_width, rect_height = 125, 38
...
def update():
    global price, prevFreeslots
    indices = [str(i + 1) for i, x in enumerate(parking_values) if x == 0]
